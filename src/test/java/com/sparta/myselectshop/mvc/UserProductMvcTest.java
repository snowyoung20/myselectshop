...
@WebMvcTest(
		controllers = {UserController.class, ProductController.class}, // 사용할 Controller 지정
...
class UserProductMvcTest {
	...
	void test1() throws Exception {
		// when - then
		mvc.perform(get("/api/user/login-page")) // mvc.perform(메서드 방식("URL"))
	...
	void test2() throws Exception {
		...
		// when - then
		mvc.perform(post("/api/user/signup") // mvc.perform(메서드 방식("URL"))
